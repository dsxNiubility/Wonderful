...
#define Wonderful_YelloeColor3 [UIColor lightCoral]
#define Wonderful_YelloeColor4 [UIColor salmonColor]
#define Wonderful_YelloeColor5 [UIColor coralColor]
#define Wonderful_YelloeColor6 [UIColor tomatoColor]
#define Wonderful_YelloeColor7 [UIColor orangeRed]
#define Wonderful_YelloeColor8 [UIColor indianRed]
#define Wonderful_YelloeColor9 [UIColor crimsonColor]
#define Wonderful_YelloeColor10 [UIColor fireBrick]
